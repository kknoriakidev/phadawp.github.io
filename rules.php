...
<!--- head --->
    ...
    <div class="card-body">
      ...
      <h4 class="card-title">Информация:</h4>
				<p class="card-text">Пожалуйста,ознакомьтесь с нашими правилами.</p>
	  </div><br>

				<a href="/info" class="btn btn-primary"> Политика конфиденциальности</a>
                &nbsp;
                <a href="/agreement" class="btn btn-primary"> Пользовательское соглашение</a>
                &nbsp;
                <a href="/serverrule" class="btn btn-primary"> Правила серверов</a>
                    </div>
								<!-- /Покупка -->
							</div>
